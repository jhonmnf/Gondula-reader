const CACHE = 'gondula-reader-v16';
const ARQUIVOS = [
  './', './index.html', './login.html', './teste-camera.html', './styles.css', './app.js', './login.js', './manifest.webmanifest', './icone.svg',
  './js/api.js', './js/auth.js', './js/camera.js', './js/camera-controls.js', './js/foto.js', './js/ui.js', './js/teste-camera.js', './conferencias.html', './js/conferencias.js'
];
